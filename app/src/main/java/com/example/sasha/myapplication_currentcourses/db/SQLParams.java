...
public class SQLParams implements BaseColumns {
    ...
    public static final String COLUMN_ORG_ID        = "org_id_for";
    ...
    public static final String CREATE_TABLE_ORGANIZATIONS =
            "CREATE TABLE "  + ORG_TABLE_NAME + "(" + ORG_ID  + " INTEGER PRIMARY KEY AUTOINCREMENT ," +
    ...
    public static final String CREATE_TABLE_CURRENCIES = "CREATE TABLE " +
